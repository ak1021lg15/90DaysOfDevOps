...
- GitHub automatically replaces secrets with ***
    ...
    ![secrets](ss/task1.1.png)

    ![MY_SECRET_MESSAGE](ss/task1.2.png)
...
3. Add `DOCKER_USERNAME` and `DOCKER_TOKEN` as secrets (you'll need these on Day 45)
    ...
    ![seceret demo](ss/task2.1.png)

   ![secret](ss/task2.2.png)
...
3. After the workflow runs, download the artifact from the Actions tab
    ...
    ![artifact](ss/task3.1.png)

    ![artifact](ss/task3.2.png)
    
    ![report](ss/task3.3.png)



   [upload-artifact](workflows/upload-artifact.yml)
...
2. Job 2: download the artifact from Job 1 and use it (print its contents)
    ...
    ![run successful](ss/task4.1.png)

    ![report file](ss/task4.2.png)
    
    ![create report](ss/task4.3.png)
    
    ![use report](ss/task4.4.png)


   [artifacts](workflows/dwnld-artifact-bw-jobs.yml)
...
4. Fix it — verify it goes green again
    ...
    ![passed test](ss/task5.1.png)

   ![test failed](ss/task5.2.png)

   [Test](workflows/run-test.yml)
...
3. Write in your notes: What is being cached and where is it stored?
    ...
    ![cache demo](ss/task6.png)

   [cache](workflows/cache-demo.yml)
