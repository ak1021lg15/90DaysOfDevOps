...
![task 4 workflow run](ss/task4.1.png)

![task 4 build and test](ss/task4.2.png)

![task 4 pr summay comment](ss/task4.3.png)
...
![task 5 workflow run all](ss/task5.1.png)

![task 5 workflow run all](ss/task5.2.png)

![task 5 deploy image in production](ss/task5.3.png)
...
3. Add a step that creates a summary using `$GITHUB_STEP_SUMMARY`:
   ...
   ```
![task 6 health check](ss/task6.1.png)

![task 6 health check](ss/task6.2.png)
