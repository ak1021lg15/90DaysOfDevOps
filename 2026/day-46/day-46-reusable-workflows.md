...
- `workflow_call` is a GitHub Actions trigger that allows a workflow to be executed by another workflow instead of events like `push` `pull_request` or `workflow_dispatch`.
...
**Verify:** Does the second job print the version from the reusable workflow?
   ...
   ![task4.1](ss/task4.1.png)

   ![print version](ss/task4.2.png)
...
**Verify:** Does your custom action run and print the greeting?
   ...
   ![composite actionss](ss/task5.png)

   [action](workflows/action.yml)

   [composite-demo](workflows/composite-demo.yml)
---
