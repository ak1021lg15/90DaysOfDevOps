...
- A **cache** (Redis)
    ...
    [Code](3-tier-web-db-cache/)

- Project Structure

    ![project structure](ss/task1.1.png)
...
2. Manually kill the database container — does it come back?
    ...
    ![image](ss/task3.2.png)
    ![image](ss/task3.3.png)
...
3. Rebuild and restart with one command
    ...
    ![docker ps before](ss/task4.2.png)
  ...
  [Compose](3-tier-web-db-cache/docker-compose.yml)
