...
2. List all images on your machine
    ...
    ![docker images](ss/s2.png)


    | Image         | Disk Usage | Content Size |
    | ------------- | ---------- | ------------ |
    | alpine:latest | 13MB     | 3.93MB       |
    | nginx:latest  | 241MB      | 66MB       |
